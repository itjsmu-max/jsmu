...
<div class="card">
  <h3>Filter</h3>
  <form method="get" style="display:grid;grid-template-columns:repeat(5,1fr);gap:10px">
    ...
    <div style="align-self:end"><button class="btn" type="submit">Terapkan</button></div>
  </form>
  <div style="margin-top:10px"><a class="btn" href="{{ route('reports.contracts.export', request()->all()) }}">Export CSV</a></div>
</div>
<div class="card">
  <table>
    <thead><tr><th>ID</th><th>No</th><th>Pegawai</th><th>Proyek</th><th>Mulai</th><th>Selesai</th><th>Status</th><th>Gaji</th><th>Tunjangan</th></tr></thead>
    <tbody>
      @foreach($rows as $r)
      <tr>
        <td>{{ $r->id }}</td>
